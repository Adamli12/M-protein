...
class AEmodel():
    def __init__(self, dat, args):
        ...
        self.module=AE(self.latent_num).to(device)
...
if __name__ == "__main__":
    ...
    aemo=AEmodel(ufeature_sc,args)
    aemo.train()
    print()
    aemo.svmtest(testfeature_sc,testlabel,svm,scaler)
